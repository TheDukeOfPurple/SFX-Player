var sounds =
	[['pg.','Script Ref', 'Name', '', 'Volume', '', 'Fade Length', 'Fade Steps'],	// these are the the column headings - don't change them
/*		
...
*/
	['ex. pg. #','ex. script ref.','example name','sin440Hz-3dBFS3s.wav','1','0', '5', '100'],
